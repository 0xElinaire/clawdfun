...
service via the external `clawdfun` CLI (no embedded runtime). This gives you
...
- The app installs a per‑user LaunchAgent labeled `com.clawdfun.gateway`
