...
- Same path: run the app from a fixed location (for Clawdfun, `dist/Clawdfun.app`).
...
```bash
sudo tccutil reset Accessibility com.clawdfun.mac
sudo tccutil reset ScreenCapture com.clawdfun.mac
