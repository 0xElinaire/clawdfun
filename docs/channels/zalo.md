...
- Install via CLI: `clawdfun plugins install @clawdfun/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `clawdfun plugins install ./extensions/zalo`
   - From npm (if published): `clawdfun plugins install @clawdfun/zalo`
...
- Approve via:
  - `clawdfun pairing list zalo`
  - `clawdfun pairing approve zalo <CODE>`
...
- Example: `clawdfun message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `clawdfun channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `clawdfun logs --follow`
