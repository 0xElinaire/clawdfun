...
read_when:
  - You want Clawdfun to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Clawdfun to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`clawdfun onboard`) and `clawdfun channels add` list optional channel plugins.
...
```bash
clawdfun plugins install @clawdfun/nostr
```

Use a local checkout (dev workflows):

```bash
clawdfun plugins install --link <path-to-clawdfun>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "clawdfun",
        "displayName": "Clawdfun",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "clawdfun@example.com",
        "lud16": "clawdfun@example.com"
      }
    }
  }
}
