...
read_when:
  ...
  - Deciding: standalone CLI vs deep Clawdfun integration
...
Recommendation: **deep integration in Clawdfun**, but keep a separable core library.

### Why integrate into Clawdfun?
- Clawdfun already knows:
  - the workspace path (`agents.defaults.workspace`)
  - the session model + heartbeats
  - logging + troubleshooting patterns
- You want the agent itself to call the tools:
  - `clawdfun memory recall "…" --k 25 --since 30d`
  - `clawdfun memory reflect --since 7d`
