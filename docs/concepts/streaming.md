...
Clawdfun has two separate “streaming” layers:
...
When block streaming is enabled, Clawdfun can **merge consecutive block chunks**
...
When draft streaming is active, Clawdfun disables block streaming for that reply to avoid double-streaming.
