---
summary: "Backstory and lore of Clawdfun for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
---
# The Lore of Clawdfun 🦞📖
...
For a brief moment, it had a different name — but everyone liked **Clawdfun** more, so that's what we settled on.
...
And so **Clawdfun** was born.

## The Name

```
Clawdfun = CLAW + TARDIS
