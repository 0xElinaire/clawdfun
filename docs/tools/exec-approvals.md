...
- **gateway host** → `clawdfun` process on the gateway machine
...
`~/.clawdfun/exec-approvals.json` directly.

CLI: `clawdfun approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
