---
summary: "Use Qwen OAuth (free tier) in Clawdfun"
read_when:
  - You want to use Qwen with Clawdfun
...
```bash
clawdfun models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Clawdfun will sync credentials
