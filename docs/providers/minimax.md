---
summary: "Use MiniMax M2.1 in Clawdfun"
read_when:
  - You want MiniMax models in Clawdfun
...
Configure manually via `clawdfun.json`:
...
- Use `clawdfun models list` and `clawdfun models set minimax/MiniMax-M2.1` to switch.
...
- Running `clawdfun configure` and selecting **MiniMax M2.1**, or
