---
summary: "Model providers (LLMs) supported by Clawdfun"
read_when:
...
Clawdfun can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `clawdfun onboard`).
