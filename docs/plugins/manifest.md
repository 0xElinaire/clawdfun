...
read_when:
  - You are building a Clawdfun plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (clawdfun.plugin.json)

Every plugin **must** ship a `clawdfun.plugin.json` file in the **plugin root**.
Clawdfun uses this manifest to validate configuration **without executing plugin
