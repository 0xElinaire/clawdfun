---
summary: "Frequently asked questions about Clawdfun setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Clawdfun?](#whats-the-recommended-way-to-install-and-set-up-clawdfun)
  ...
  - [I can't access docs.clawd.bot (SSL error). What now?](#i-cant-access-docsclawdfun-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or clawdfun not recognized](#windows-install-says-git-not-found-or-clawdfun-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Clawdfun on Linux?](#how-do-i-install-clawdfun-on-linux)
  - [How do I install Clawdfun on a VPS?](#how-do-i-install-clawdfun-on-a-vps)
  ...
  - [If I buy a Mac mini to run Clawdfun, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-clawdfun-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Clawdfuns?](#can-multiple-people-use-one-whatsapp-number-with-different-clawdfuns)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Clawdfun on a dedicated machine?](#how-important-is-it-to-run-clawdfun-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Clawdfun in a VM and what are the requirements](#can-i-run-clawdfun-in-a-vm-and-what-are-the-requirements)
- [What is Clawdfun?](#what-is-clawdfun)
  - [What is Clawdfun, in one paragraph?](#what-is-clawdfun-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Clawdfun](#what-are-the-top-five-everyday-use-cases-for-clawdfun)
  - [Can Clawdfun help with lead gen outreach ads and blogs for a SaaS](#can-clawdfun-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Clawdfun run tasks on a schedule or continuously in the background?](#can-clawdfun-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Clawdfun saved locally?](#is-all-data-used-with-clawdfun-saved-locally)
  - [Where does Clawdfun store its data?](#where-does-clawdfun-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Clawdfun?](#how-do-i-completely-uninstall-clawdfun)
...
- [Config basics](#config-basics)
  ...
  - [Can the Clawdfun browser run headless?](#can-the-clawdfun-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Clawdfuns talk to each other (local + VPS)?](#can-two-clawdfuns-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Clawdfun load environment variables?](#how-does-clawdfun-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Clawdfuns one CEO and many agents](#is-there-a-way-to-make-a-team-of-clawdfuns-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Clawdfun but keep it installed?](#how-do-i-completely-reset-clawdfun-but-keep-it-installed)
  ...
  - [Why doesn’t Clawdfun reply in a group?](#why-doesnt-clawdfun-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `clawdfun gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-clawdfun-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `clawdfun gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-clawdfun-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Clawdfun in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-clawdfun-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Clawdfun?](#i-closed-my-terminal-on-windows-how-do-i-restart-clawdfun)
  ...
  - [ELI5: `clawdfun gateway restart` vs `clawdfun gateway`](#eli5-clawdfun-gateway-restart-vs-clawdfun-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Clawdfun to inbound DMs?](#is-it-safe-to-expose-clawdfun-to-inbound-dms)
...
3) **Daemon + port state**
   ```bash
   clawdfun gateway status
   ```
   Shows supervisor runtime vs RPC reachability, the probe target URL, and which config the service likely used.

4) **Deep probes**
   ```bash
   clawdfun status --deep
   ```
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/clawdfun/clawdfun-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ```bash
   clawdfun health --json
   clawdfun health --verbose   # shows the target URL + config path on errors
   ```
...
This installs Clawdfun **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/clawdfun/clawdfun/issues
https://github.com/clawdfun/clawdfun/pulls
...
What they do:
- `clawdfun status`: quick snapshot of gateway/agent health + basic config.
- `clawdfun models status`: checks provider auth + model availability.
- `clawdfun doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `clawdfun status --all`, `clawdfun logs --follow`,
`clawdfun gateway status`, `clawdfun health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up Clawdfun

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://clawd.bot/install.sh | bash
clawdfun onboard --install-daemon
```
...
```bash
git clone https://github.com/clawdfun/clawdfun.git
cd clawdfun
pnpm install
pnpm build
...
If you don’t have a global install yet, run it via `pnpm clawdfun onboard`.
...
- If it asks for auth, run `clawdfun dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `CLAWDBOT_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `clawdfun gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `clawdfun gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `clawdfun dashboard`.
...
1) Install Clawdfun on the new machine.
2) Copy `$CLAWDBOT_STATE_DIR` (default: `~/.clawdfun`) from the old machine.
3) Copy your workspace (default: `~/clawd`).
4) Run `clawdfun doctor` and restart the Gateway service.
...
under `~/.clawdfun/` (for example `~/.clawdfun/agents/<agentId>/sessions/`).

Related: [Where things live on disk](/help/faq#where-does-clawdfun-store-its-data),
...
https://github.com/clawdfun/clawdfun/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docsclawdfun SSL error What now
...
detail: [Troubleshooting](/help/troubleshooting#docsclawdfun-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/clawdfun/clawdfun/tree/main/docs
...
### Windows install says git not found or clawdfun not recognized
...
**2) clawdfun is not recognized after install**
...
### How do I install Clawdfun on Linux
...
### How do I install Clawdfun on a VPS
...
```bash
clawdfun update
clawdfun update status
clawdfun update --channel stable|beta|dev
clawdfun update --tag <dist-tag|version>
clawdfun update --no-restart
```

If you must automate from an agent:

```bash
clawdfun update --yes --no-restart
clawdfun gateway restart
```
...
`clawdfun onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Clawdfun with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. If Claude Code CLI credentials are present on the gateway host, Clawdfun can reuse them; otherwise choose **Anthropic token (paste setup-token)** and paste the string. The token is stored as an auth profile for the **anthropic** provider and used like an API key or OAuth profile. More detail: [OAuth](/concepts/oauth).

Clawdfun keeps `auth.profiles["anthropic:claude-cli"].mode` set to `"oauth"` so
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `clawdfun models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `clawdfun models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth Claude Code OAuth

Yes. Clawdfun can **reuse Claude Code CLI credentials** (OAuth) and also supports **setup-token**. If you have a Claude subscription, we recommend **setup-token** for long‑running setups (requires Claude Pro/Max + the `claude` CLI). You can generate it anywhere and paste it on the gateway host. OAuth reuse is supported, but avoid logging in separately via Clawdfun and Claude Code to prevent token conflicts. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Clawdfun can keep replying while a provider is rate‑limited.
...
Clawdfun supports **OpenAI Code (Codex)** via OAuth or by reusing your Codex CLI login (`~/.codex/auth.json`). The wizard can import the CLI login or run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Clawdfun fully supports **OpenAI Code (Codex) subscription OAuth** and can also reuse an
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `clawdfun.json`.

Steps:
1) Enable the plugin: `clawdfun plugins enable google-gemini-cli-auth`
2) Login: `clawdfun models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Clawdfun needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Clawdfun runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Clawdfun’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Clawdfun can I connect it to my MacBook Pro
...
- Use `clawdfun nodes status` / `clawdfun nodes list` to see it.
...
- DM your bot, then run `clawdfun logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Clawdfuns
...
If you run Clawdfun via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the Clawdfun code install. Your state
(`~/.clawdfun`) and workspace (`~/clawd`) stay untouched.
...
**Clawdfun-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Clawdfun on a dedicated machine
...
Clawdfun is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Clawdfun in a VM and what are the requirements
...
### What is Clawdfun in one paragraph

Clawdfun is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

Clawdfun is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Clawdfun
...
### Can Clawdfun help with lead gen outreach ads and blogs for a SaaS
...
Clawdfun draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Clawdfun is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Clawdfun when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.clawdfun/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.clawdfun/clawdfun.json`). Precedence is `<workspace>/skills` > `~/.clawdfun/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.clawdfun/clawdfun.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.clawdfun/skills` → bundled → `skills.load.extraDirs`. `clawdhub` installs into `./skills` by default, which Clawdfun treats as `<workspace>/skills`.
...
Debug:
```bash
clawdfun cron run <jobId> --force
clawdfun cron runs --id <jobId> --limit 50
```
...
### Can Clawdfun run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.clawdfun.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-clawdfun-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Clawdfun can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.clawdfun/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"clawdfun":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Clawdfun only needs stdio). See [iMessage](/channels/imessage).
...
ClawdHub installs into `./skills` under your current directory (or falls back to your configured Clawdfun workspace); Clawdfun treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.clawdfun/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawdHub](/tools/clawdhub).
...
If the Gateway runs on the same machine as Chrome (default setup), you usually **do not** need `clawdfun browser serve`.
...
Clawdfun memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Clawdfun also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Clawdfun auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Clawdfun
prefers `local`.
...
### Is all data used with Clawdfun saved locally

No - **Clawdfun’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.clawdfun` + your workspace directory).
...
### Where does Clawdfun store its data

Everything lives under `$CLAWDBOT_STATE_DIR` (default: `~/.clawdfun`):

| Path | Purpose |
|------|---------|
| `$CLAWDBOT_STATE_DIR/clawdfun.json` | Main config (JSON5) |
...
Legacy single‑agent path: `~/.clawdfun/agent/*` (migrated by `clawdfun doctor`).
...
These files live in the **agent workspace**, not `~/.clawdfun`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.clawdfun`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.clawdfun/skills`).
...
Do **not** commit anything under `~/.clawdfun` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Clawdfun
...
`workspace` to the repo root. The Clawdfun repo is just source code; keep the
...
Clawdfun reads an optional **JSON5** config from `$CLAWDBOT_CONFIG_PATH` (default: `~/.clawdfun/clawdfun.json`):
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `clawdfun doctor --generate-gateway-token`.
...
key. **Recommended:** run `clawdfun configure --section web` to store it in
...
- Daemons read env vars from `~/.clawdfun/.env` (or the service environment).
...
### Can the Clawdfun browser run headless
...
5) Approve the node on the Gateway:
   ```bash
   clawdfun nodes pending
   clawdfun nodes approve <requestId>
   ```
...
Check the basics:
- Gateway is running: `clawdfun gateway status`
- Gateway health: `clawdfun status`
- Channel health: `clawdfun channels status`
...
### Can two Clawdfuns talk to each other local VPS
...
`clawdfun agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on Railway/VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
clawdfun agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- **Local browser automation.** Keep the Gateway on a VPS, but run Chrome locally and relay control
  with the Chrome extension + `clawdfun browser serve`.
...
Recover:
- Restore from backup (git or a copied `~/.clawdfun/clawdfun.json`).
- If you have no backup, re-run `clawdfun doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `clawdfun config set` for small changes.
- Use `clawdfun configure` for interactive edits.
...
```bash
clawdfun gateway --tailscale serve
```
...
### How does Clawdfun load environment variables

Clawdfun reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.clawdfun/.env` (aka `$CLAWDBOT_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.clawdfun/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`clawdfun models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Clawdfun won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.clawdfun/.env`:
   ```
...
### Is there a way to make a team of Clawdfuns one CEO and many agents
...
### How do I completely reset Clawdfun but keep it installed
...
```bash
clawdfun reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `CLAWDBOT_PROFILE`), reset each state dir (defaults are `~/.clawdfun-<profile>`).
- Dev reset: `clawdfun gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Clawdfun skips the heartbeat run to save API calls.
...
No. Clawdfun runs on **your own account**, so if you’re in the group, Clawdfun can see it.
...
```bash
clawdfun directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Clawdfun reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.clawdfun/agents/<agentId>/sessions/`.
...
- Use `clawdfun doctor` to spot stray workspaces and profile mismatches.
...
Clawdfun’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Clawdfun currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `clawdfun models set ...` (updates just model config)
- `clawdfun configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.clawdfun/clawdfun.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `clawdfun doctor` to repair.
...
Yes. Clawdfun ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.clawdfun/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `clawdfun agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Clawdfun can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.clawdfun/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.clawdfun/agent/*` (migrated by `clawdfun doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.clawdfun/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `clawdfun models status` to see configured models and whether providers are authenticated.
...
- **Sync the Claude Code CLI token on the gateway host**
  - Run `clawdfun models status` (it loads + syncs Claude Code CLI credentials).
  - If it still says missing: run `claude setup-token` (or `clawdfun models auth setup-token --provider anthropic`) and retry.
- **If the token was created on another machine**
  - Paste it into the gateway host with `clawdfun models auth paste-token --provider anthropic`.
- **Check the profile mode**
  - `auth.profiles["anthropic:claude-cli"].mode` must be `"oauth"` (token mode rejects OAuth credentials).
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.clawdfun/.env` on the **gateway host**.
  - Clear any pinned order that forces `anthropic:claude-cli`:
    ```bash
    clawdfun models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Clawdfun will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Clawdfun now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Clawdfun uses provider‑prefixed IDs like:
...
Clawdfun may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `clawdfun models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
clawdfun models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
clawdfun models auth order set --provider anthropic anthropic:claude-cli

# Or set an explicit order (fallback within provider)
clawdfun models auth order set --provider anthropic anthropic:claude-cli anthropic:default
...
```bash
clawdfun models auth order set --provider anthropic --agent main anthropic:claude-cli
```

### OAuth vs API key whats the difference

Clawdfun supports both:
...
### Why does clawdfun gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `clawdfun gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does clawdfun gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `CLAWDBOT_STATE_DIR` mismatch).

Fix:
```bash
clawdfun gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

Clawdfun enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `clawdfun gateway --port <port>`.

### How do I run Clawdfun in remote mode client connects to a Gateway elsewhere
...
Notes:
- `clawdfun gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `clawdfun.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `clawdfun dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `clawdfun doctor --generate-gateway-token`.
...
- Still stuck? Run `clawdfun status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `clawdfun --profile <name> …` per instance (auto-creates `~/.clawdfun-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `clawdfun --profile <name> gateway install`.

Profiles also suffix service names (`com.clawdfun.<profile>`, `clawdfun-gateway-<profile>.service`, `Clawdfun Gateway (<profile>)`).
...
```
clawdfun tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/clawdfun/clawdfun-YYYY-MM-DD.log
```
...
- macOS: `$CLAWDBOT_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.clawdfun/logs/...`; profiles use `~/.clawdfun-<profile>/logs/...`)
- Linux: `journalctl --user -u clawdfun-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Clawdfun Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `clawdfun gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Clawdfun
...
1) Is the Gateway running? `clawdfun gateway status`
2) Is the Gateway healthy? `clawdfun status`
3) Does the UI have the right token? `clawdfun dashboard`
...
```bash
clawdfun channels status
clawdfun channels logs --channel telegram
```
...
```bash
clawdfun gateway stop
clawdfun gateway start
```
...
### ELI5 clawdfun gateway restart vs clawdfun gateway

- `clawdfun gateway restart`: restarts the **background service** (launchd/systemd).
- `clawdfun gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `clawdfun gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Clawdfun assistant setup](/start/clawd) and [Agent send](/tools/agent-send).

CLI sending:

```bash
clawdfun message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Clawdfun to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `clawdfun pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `clawdfun pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `clawdfun doctor` to surface risky DM policies.
...
```bash
clawdfun pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Clawdfun only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
clawdfun pairing approve whatsapp <code>
```

List pending requests:

```bash
clawdfun pairing list whatsapp
```
...
Clawdfun blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In Clawdfun, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/clawdfun/clawdfun/discussions).
