...
export function registerBrowserCli(program) {
    const browser = program
        ...
        .option("--url <url>", "Override browser control URL (default from ~/.clawdfun/clawdfun.json)")
        ...
        .action(() => {
        browser.outputHelp();
        defaultRuntime.error(danger(`Missing subcommand. Try: "${formatCliCommand("clawdfun browser status")}"`));
