...
const SANDBOX_EXAMPLES = {
    main: [
        ["clawdfun sandbox list", "List all sandbox containers."],
        ["clawdfun sandbox list --browser", "List only browser containers."],
        ["clawdfun sandbox recreate --all", "Recreate all containers."],
        ["clawdfun sandbox recreate --session main", "Recreate a specific session."],
        ["clawdfun sandbox recreate --agent mybot", "Recreate agent containers."],
        ["clawdfun sandbox explain", "Explain effective sandbox config."],
    ],
    list: [
        ["clawdfun sandbox list", "List all sandbox containers."],
        ["clawdfun sandbox list --browser", "List only browser containers."],
    ...
    recreate: [
        ["clawdfun sandbox recreate --all", "Recreate all containers."],
        ["clawdfun sandbox recreate --session main", "Recreate a specific session."],
        ["clawdfun sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
        ["clawdfun sandbox recreate --browser --all", "Recreate only browser containers."],
        ["clawdfun sandbox recreate --all --force", "Skip confirmation."],
    ],
    explain: [
        ["clawdfun sandbox explain", "Show effective sandbox config."],
        ["clawdfun sandbox explain --session agent:main:main", "Explain a specific session."],
        ["clawdfun sandbox explain --agent work", "Explain an agent sandbox."],
        ["clawdfun sandbox explain --json", "JSON output."],
    ],
};
