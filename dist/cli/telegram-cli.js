...
import { approveTelegramPairingCode, listTelegramPairingRequests, } from "../telegram/pairing-store.js";
import { sendMessageTelegram } from "../telegram/send.js";
import { resolveTelegramToken } from "../telegram/token.js";
export function registerTelegramCli(program) {
    ...
    pairing
        ...
        for (const r of requests) {
            ...
            console.log(`${r.code}  chatId=${r.chatId}${who ? `  ${who}` : ""}  ${r.createdAt}`);
        }
    });
    pairing
        .command("approve")
        ...
        await sendMessageTelegram(approved.chatId, "✅ Clawdfun access approved. Send a message to start chatting.", { token }).catch((err) => {
