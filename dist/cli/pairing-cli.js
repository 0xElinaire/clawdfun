...
export function registerPairingCli(program) {
    ...
    pairing
        ...
        if (!opts.channel && !code) {
            throw new Error(`Usage: ${formatCliCommand("clawdfun pairing approve <channel> <code>")} (or: ${formatCliCommand("clawdfun pairing approve --channel <channel> <code>")})`);
        }
        if (opts.channel && code != null) {
            throw new Error(`Too many arguments. Use: ${formatCliCommand("clawdfun pairing approve --channel <channel> <code>")}`);
        }
        const channel = parseChannel(channelRaw, channels);
