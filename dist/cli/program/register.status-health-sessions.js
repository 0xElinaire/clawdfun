...
export function registerStatusHealthSessionsCommands(program) {
    program
        ...
        ["clawdfun status", "Show channel health + session summary."],
        ["clawdfun status --all", "Full diagnosis (read-only)."],
        ["clawdfun status --json", "Machine-readable output."],
        ["clawdfun status --usage", "Show model provider usage/quota snapshots."],
        [
            "clawdfun status --deep",
            "Run channel probes (WA + Telegram + Discord + Slack + Signal).",
        ],
        ["clawdfun status --deep --timeout 5000", "Tighten probe timeout."],
    ])}`)
    ...
    program
        ...
        .addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
        ["clawdfun sessions", "List all sessions."],
        ["clawdfun sessions --active 120", "Only last 2 hours."],
        ["clawdfun sessions --json", "Machine-readable output."],
        ["clawdfun sessions --store ./tmp/sessions.json", "Use a specific session store."],
