...
import { CONFIG_PATH_CLAWDFUN, loadConfig, parseConfigJson5, readConfigFileSnapshot, resolveConfigSnapshotHash, validateConfigObject, writeConfigFile, } from "../config/config.js";
import { applyLegacyMigrations } from "../config/legacy.js";
import { applyMergePatch } from "../config/merge-patch.js";
import { buildConfigSchema } from "../config/schema.js";
import { listChannelPlugins } from "../channels/plugins/index.js";
import { loadClawdfunPlugins } from "../plugins/loader.js";
...
function requireConfigBaseHash(params, snapshot) {
    if (!snapshot.exists)
        return { ok: true };
...
export const handleConfigBridgeMethods = async (_ctx, _nodeId, method, params) => {
    switch (method) {
        case "config.get": {
        ...
        case "config.schema": {
            ...
            const pluginRegistry = loadClawdfunPlugins({
                config: cfg,
                workspaceDir,
                logger: {
                    info: () => { },
