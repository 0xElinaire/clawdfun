import { createClawdfunTools } from "../agents/clawdfun-tools.js";
...
export async function handleToolsInvokeHttpRequest(req, res, opts) {
    ...
    const messageChannel = normalizeMessageChannel(getHeader(req, "x-clawdfun-message-channel") ?? "");
    const accountId = getHeader(req, "x-clawdfun-account-id")?.trim() || undefined;
    ...
    const allTools = createClawdfunTools({
