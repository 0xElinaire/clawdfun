...
export const DEFAULT_LOG_DIR = "/tmp/clawdfun";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "clawdfun.log"); // legacy single-file path
const LOG_PREFIX = "clawdfun";
