...
export const A2UI_PATH = "/__clawdfun__/a2ui";
export const CANVAS_HOST_PATH = "/__clawdfun__/canvas";
export const CANVAS_WS_PATH = "/__clawdfun/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.clawdfunCanvasA2UIAction.postMessage(...)
  // - Android: window.clawdfunCanvasA2UIAction.postMessage(...)
  const actionHandlerName = "clawdfunCanvasA2UIAction";
  ...
  globalThis.Clawdfun = globalThis.Clawdfun ?? {};
  globalThis.Clawdfun.postMessage = postToNode;
  globalThis.Clawdfun.sendUserAction = sendUserAction;
  globalThis.clawdfunPostMessage = postToNode;
  globalThis.clawdfunSendUserAction = sendUserAction;
