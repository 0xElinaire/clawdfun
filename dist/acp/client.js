...
export async function createAcpClient(opts = {}) {
    ...
    ensureClawdfunCliOnPath({ cwd });
    const serverCommand = opts.serverCommand ?? "clawdfun";
    ...
    await client.initialize({
        ...
        clientInfo: { name: "clawdfun-acp-client", version: "1.0.0" },
    });
...
export async function runAcpClientInteractive(opts = {}) {
    ...
    console.log("Clawdfun ACP client");
