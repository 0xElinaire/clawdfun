...
import { STATE_DIR_CLAWDFUN } from "../../config/config.js";
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".clawdfun", "sandboxes");
export const DEFAULT_SANDBOX_IMAGE = "clawdfun-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "clawdfun-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "clawdfun-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "clawdfun-sandbox-common:bookworm-slim";
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "clawdfun-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR_CLAWDFUN ?? path.join(os.homedir(), ".clawdfun");
