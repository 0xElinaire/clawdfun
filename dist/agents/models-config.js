...
export async function ensureClawdfunModelsJson(config, agentDirOverride) {
    const cfg = config ?? loadConfig();
    const agentDir = agentDirOverride?.trim() ? agentDirOverride.trim() : resolveClawdfunAgentDir();
