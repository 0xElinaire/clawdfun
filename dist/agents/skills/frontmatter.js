...
export function resolveClawdfunMetadata(frontmatter) {
    ...
    try {
        ...
        return {
            ...
            skillKey: typeof clawdfunObj.skillKey === "string" ? clawdfunObj.skillKey : undefined,
            primaryEnv: typeof clawdfunObj.primaryEnv === "string" ? clawdfunObj.primaryEnv : undefined,
...
export function resolveSkillKey(skill, entry) {
    return entry?.clawdfun?.skillKey ?? skill.name;
}
