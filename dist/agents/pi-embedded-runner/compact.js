...
import { resolveClawdfunAgentDir } from "../agent-paths.js";
import { resolveSessionAgentIds } from "../agent-scope.js";
import { makeBootstrapWarn, resolveBootstrapContextForRun } from "../bootstrap-files.js";
import { resolveClawdfunDocsPath } from "../docs-path.js";
import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "../defaults.js";
import { getApiKeyForModel, resolveModelAuthMode } from "../model-auth.js";
import { ensureClawdfunModelsJson } from "../models-config.js";
...
import { createClawdfunCodingTools } from "../pi-tools.js";
...
export async function compactEmbeddedPiSessionDirect(params) {
    ...
    const agentDir = params.agentDir ?? resolveClawdfunAgentDir();
    await ensureClawdfunModelsJson(params.config, agentDir);
    ...
    try {
        ...
        const toolsRaw = createClawdfunCodingTools({
            exec: {
        ...
        const docsPath = await resolveClawdfunDocsPath({
            workspaceDir: effectiveWorkspace,
