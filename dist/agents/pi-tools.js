...
import { createClawdfunTools } from "./clawdfun-tools.js";
...
import { assertRequiredParams, CLAUDE_PARAM_GROUPS, createClawdfunReadTool, createSandboxedEditTool, createSandboxedReadTool, createSandboxedWriteTool, normalizeToolParams, patchToolSchemaForClaudeCompatibility, wrapToolParamNormalization, } from "./pi-tools.read.js";
...
export function createClawdfunCodingTools(options) {
    ...
    const base = codingTools.flatMap((tool) => {
        if (tool.name === readTool.name) {
            ...
            return [createClawdfunReadTool(freshReadTool)];
        }
