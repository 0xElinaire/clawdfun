...
export function buildServiceEnvironment(params) {
    ...
    return {
        ...
        CLAWDFUN_PROFILE: profile,
        CLAWDFUN_STATE_DIR: env.CLAWDFUN_STATE_DIR,
        CLAWDFUN_CONFIG_PATH: env.CLAWDFUN_CONFIG_PATH,
        CLAWDFUN_GATEWAY_PORT: String(port),
        CLAWDFUN_GATEWAY_TOKEN: token,
        CLAWDFUN_LAUNCHD_LABEL: resolvedLaunchdLabel,
        CLAWDFUN_SYSTEMD_UNIT: systemdUnit,
        CLAWDFUN_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
        CLAWDFUN_SERVICE_KIND: GATEWAY_SERVICE_KIND,
        CLAWDFUN_SERVICE_VERSION: VERSION,
    };
}
