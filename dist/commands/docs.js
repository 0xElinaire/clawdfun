...
const SEARCH_TOOL = "https://docs.clawd.bot/mcp.SearchClawdfun";
...
export async function docsSearchCommand(queryParts, runtime) {
    ...
    if (!query) {
        ...
        if (isRich()) {
            ...
            runtime.log(`${theme.muted("Search:")} ${formatCliCommand('clawdfun docs "your query"')}`);
        }
        else {
            runtime.log("Docs: https://docs.clawd.bot/");
            runtime.log(`Search: ${formatCliCommand('clawdfun docs "your query"')}`);
        }
        return;
    }
