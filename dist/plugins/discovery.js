...
function resolvePackageExtensions(manifest) {
    const raw = manifest.clawdfun?.extensions;
...
function deriveIdHint(params) {
    ...
    // package is scoped (example: @clawdfun/voice-call -> voice-call).
...
function addCandidate(params) {
    ...
    params.candidates.push({
        ...
        packageClawdfun: manifest?.clawdfun,
    });
}
...
export function discoverClawdfunPlugins(params) {
    const candidates = [];
    const diagnostics = [];
    const seen = new Set();
    ...
    if (workspaceDir) {
        ...
        const workspaceExt = path.join(workspaceRoot, ".clawdfun", "extensions");
        discoverInDirectory({
            dir: workspaceExt,
            origin: "workspace",
