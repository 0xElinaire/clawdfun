...
export function triggerClawdfunRestart() {
    ...
    if (process.platform !== "darwin") {
        if (process.platform === "linux") {
            const unit = normalizeSystemdUnit(process.env.CLAWDFUN_SYSTEMD_UNIT, process.env.CLAWDFUN_PROFILE);
    ...
    const label = process.env.CLAWDFUN_LAUNCHD_LABEL ||
        resolveGatewayLaunchAgentLabel(process.env.CLAWDFUN_PROFILE);
